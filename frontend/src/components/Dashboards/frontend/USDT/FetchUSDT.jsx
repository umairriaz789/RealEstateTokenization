...
import ChartFrontend from './cahrtFrontend';



export const FetchUSDT = () => {
    ...
    <CardFrontend 
     ...
     currentPrice={state.Data.market_data ? state.Data.market_data.current_price["usd"] : ""}
      ...
      low24={state.Data.market_data ? state.Data.market_data.low_24h["usd"] : ""}
       />
    <ChartFrontend Id={state.Id} priceChange24={state.Data.market_data ? state.Data.market_data.price_change_24h_in_currency.usd : ""}
